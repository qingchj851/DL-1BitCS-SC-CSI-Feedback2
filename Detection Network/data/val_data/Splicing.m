...
load('val_data_1.mat','CSI_bitR1','US_bitR1','yR1')
load('val_data_2.mat','CSI_bitR2','US_bitR2','yR2')
load('val_data_3.mat','CSI_bitR3','US_bitR3','yR3')
load('val_data_4.mat','CSI_bitR4','US_bitR4','yR4')
load('val_data_5.mat','CSI_bitR5','US_bitR5','yR5')
load('val_data_6.mat','CSI_bitR6','US_bitR6','yR6')
load('val_data_7.mat','CSI_bitR7','US_bitR7','yR7')
load('val_data_8.mat','CSI_bitR8','US_bitR8','yR8')
...
save('val_data.mat','CSI_bitR','US_bitR','yR')